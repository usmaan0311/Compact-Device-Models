...
Poisson::Poisson(double tsi, double tox,double Na, double tol,int maxiter, int nx)
{
...
double* Poisson::FinDiff(double* A, double* resid,int* iteration, int* iter, double Vgs)
{
